...
#define PATH_NOT_FOUND_COLOR RED
    ...
    //for displaying the game statistics on the screen
    ...
    //for showing the game result on the screen
...
//for drawing the menu on the screen
...
void drawMenu()
{
    ...
    outtextxy(10, 30, (char *)"Welcome to Maze Game and Solver");
